        ...
        mAddToCart.setOnClickListener(view -> {
            if (feature != null) {
                mStore.collection("Users").document(mAuth.getCurrentUser().getUid())
                        .collection("Cart").add(feature).addOnCompleteListener(task -> Toast.makeText(DetailActivity.this, "Item Added to Cart", Toast.LENGTH_SHORT).show());
            }
            if (bestSell != null) {
                mStore.collection("Users").document(mAuth.getCurrentUser().getUid())
                        .collection("Cart").add(bestSell).addOnCompleteListener(task -> Toast.makeText(DetailActivity.this, "Item Added to Cart", Toast.LENGTH_SHORT).show());
            }
            if (items != null) {
                mStore.collection("Users").document(mAuth.getCurrentUser().getUid())
                        .collection("Cart").add(items).addOnCompleteListener(task -> Toast.makeText(DetailActivity.this, "Item Added to Cart", Toast.LENGTH_SHORT).show());
            }
